...
pool.getConnection(function(err, connection) {
    connection.query('CREATE TABLE my_user(user_id VARCHAR(128) NOT NULL, user_token VARCHAR(255), user_name VARCHAR(40), user_description VARCHAR(32), user_group Int, user_heart_num Int, user_registration_date DATETIME DEFAULT CURRENT_TIMESTAMP, user_last_visit_date DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY(user_id));',
    function(err, result) {
